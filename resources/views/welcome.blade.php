    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-9 d-flex align-items-center justify-content-lg-between">
          ...
          <a href="{{url('login')}}" class="get-started-btn scrollto">Get Started</a>
        </div>
      </div>
    ...
    <section id="features" class="features">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="image col-lg-6 order-1 order-lg-2" style='background-image: url("public/assets/img/features.jpg");'></div>
        </div>
    ...
    <section id="faq" class="faq">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style='background-image: url("public/assets/img/faq.jpg");'>&nbsp;</div>
        </div>
