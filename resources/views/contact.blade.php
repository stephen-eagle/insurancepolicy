  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="{{asset('/')}}"><h2>Insurance Policy Management System</h2></a>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="{{asset('services')}}">Our Services</a>
              </li>
    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>Contact Us</h1>
            <p><a href="{{asset('home')}}">Home</a> / <span>Contact Us</span></p>
          </div>
        </div>
      </div>
    </div>
