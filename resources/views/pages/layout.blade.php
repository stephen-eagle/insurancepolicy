...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Insurance System</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="public/asset/img/profile-img.jpg" alt="Profile" class="rounded-circle">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link @if(!request()->is('admin/insurance*')) collapsed @endif" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{url('admin/insurance/create')}}">
              <i class="bi bi-circle"></i><span>Insurances</span>
            </a>
          </li>
        </ul>
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{url('admin/policy/create')}}">
              <i class="bi bi-circle"></i><span>Insurance Policies</span>
            </a>
          </li>
        </ul>
      </li><!-- End Forms Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text"></i><span>Complains</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{url('admin/complain/create')}}">
              <i class="bi bi-circle"></i><span>Add Complains</span>
            </a>
          </li>
           <li>
            <a href="{{url('admin/complain')}}">
              <i class="bi bi-circle"></i><span>View all Complains</span>
            </a>
          </li>
        </ul>
      </li><!-- End Forms Nav -->
