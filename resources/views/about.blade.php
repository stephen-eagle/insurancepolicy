  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="{{url('/')}}"><h2>Insurance Policy Management System</h2></a>
    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>About Us</h1>
            <p><a href="{{url('home')}}">Home</a> / <span>About Us</span></p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="left-image">
              <img src="public/assets/images/our-team.jpg" alt="">
            </div>
          </div>
          <div class="col-md-6">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="team-item">
              <img src="public/assets/images/team-01.jpg" alt="">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="team-item">
              <img src="public/assets/images/team-02.jpg" alt="">
              <div class="down-content">
                <h4>Mary Morris</h4>
                <span>Co-Founder</span>
              </div>
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="team-item">
              <img src="public/assets/images/team-03.jpg" alt="">
              <div class="down-content">
                <h4>George White</h4>
                <span>Co-Founder</span>
              </div>
