        ...
        <div class="container">
          ...
          <div class="functional-buttons">
            <ul>
              ...
              <li><a href="{{url('booking')}}">Apply</a></li>
            </ul>
          </div>
        </div>
      </nav>
        ...
        <div class="row">
          <div class="col-md-8 offset-md-2">
            <div class="section-heading">
              ...
              <p>Insurance Policy Management System offers Services at Customer Convinient Policy Plans at an affordable price</p>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="pricing-item">
              <h4>Basic Insurance Policy</h4>
              <div class="price">
                <h6>ksh 1500</h6>
                <span>monthly</span>
              </div>
              <p>Basic Plans have various Policies </p>
              <div class="dev"></div>
              <ul>
                <li><i class="fa fa-check"></i>Housing Insurance</li>
                <li><i class="fa fa-check"></i>Life Insurance</li>
                <li><i class="fa fa-check"></i>Vehicle Insurance</li>
                <li><i class="fa fa-check"></i>Death Insurance</li>
                <li><i class="fa fa-check"></i>Education Insurance</li>
                <li><i class="fa fa-check"></i>Health Insurance</li>
              </ul>
              <a href="{{url('booking')}}" class="main-button">Start Plan</a>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="pricing-item">
              ...
              <a href="{{url('booking')}}" class="gradient-button">Start Plan</a>
            </div>
          </div>
          <div class="col-md-4 col-sm-6 col-xs-12">
            <div class="pricing-item">
              <h4>Advanced Insurance Policy</h4>
              <div class="price">
                <h6>ksh 7225</h6>
                <span>monthly</span>
              </div>
    ...
    <div class="services-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <span>Insurance Services we Provide</span>
