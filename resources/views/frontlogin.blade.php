            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form method="post" action="{{url('customer/login')}}" class="row g-3 needs-validation" novalidate>
                  	@csrf
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Email Address</label>
                      <div class="input-group has-validation">
                        <span class="input-group-text" id="inputGroupPrepend">@</span>
                        <input type="email" name="email" class="form-control" id="yourUsername" @if(Cookie::has('adminuser')) value="{{Cookie::get('adminuser')}}" @endif required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="password" class="form-control" id="yourPassword"  @if(Cookie::has('adminpwd')) value="{{Cookie::get('adminpwd')}}" @endif required>
                      <div class="invalid-feedback">Please enter your password with more than 8 characters!</div>
                    </div>

                    <div class="col-12">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="remember" value="true" @if(Cookie::has('adminuser')) checked @endif id="rememberMe">
